...
To decode the files, each integer must be converted to binary, and leading zeros must be added on the left to reach a 32-bit integer (the decoding of the last number can be found in the code).
